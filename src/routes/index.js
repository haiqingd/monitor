...
router.post('/api/settings/prometheusConfig_global',backendSettings.setPrometheusConfig_gl)
...
router.post('/api/settings/rules',backendSettings.setRule)
router.put('/api/settings/rules',backendSettings.alterRule)
router.delete('/api/settings/rules',backendSettings.delRule)
