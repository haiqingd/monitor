...
const table = " (\n\
    DBid INT PRIMARY KEY AUTO_INCREMENT, # id主键自增\n\
    Host VARCHAR(20) NOT NULL, #被监控端IP\n\
...
async function create() {
    await query("CREATE TABLE if not exists "+table_name_database + table)
    console.log(table_name_database + "db ready")
  }
